class Airflowctl < Formula
  include Language::Python::Virtualenv

  desc "Official Apache Airflow CLI for talking to an Airflow REST API"
  homepage "https://airflow.apache.org/docs/apache-airflow-ctl/stable/index.html"
  url "https://files.pythonhosted.org/packages/ef/cf/756e2d56ff03b71fcf40a5589204cc461c27726c88ea11fa295bbef9f388/apache_airflow_ctl-0.1.5.tar.gz"
  sha256 "4216fb919b6281de42ffe5f189c63411417cf95f69d80d6aa28d7159001334c9"
  license "Apache-2.0"

  # PyPI package name is "apache-airflow-ctl". The "airflowctl" package
  # is unrelated and (apparently) unmaintained. I'm reusing the name
  # 'airflowctl' here because it is simpler, but also because this is a
  # tap, and not an official repository.
  depends_on "libyaml"
  ...
  resource "uuid6" do
    url "https://files.pythonhosted.org/packages/ca/b7/4c0f736ca824b3a25b15e8213d1bcfc15f8ac2ae48d1b445b310892dc4da/uuid6-2025.0.1.tar.gz"
    sha256 "cd0af94fa428675a44e32c5319ec5a3485225ba2179eefcf4c3f205ae30a81bd"
  end

  resource "wirerope" do
  ...
  test do
    assert_match version.to_s, shell_output("#{bin}/airflowctl --help")
  end
end
